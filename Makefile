...
C_SOURCES = $(SRCDIR)/math.c $(SRCDIR)/shape.c $(SRCDIR)/body.c $(SRCDIR)/constraint.c $(SRCDIR)/collision.c $(SRCDIR)/collision_detect.c $(SRCDIR)/physics.c $(SRCDIR)/physics_lifecycle.c $(SRCDIR)/physics_runtime_api.c $(SRCDIR)/physics_config.c $(SRCDIR)/physics_query.c $(SRCDIR)/physics_mutation.c $(SRCDIR)/physics_pipeline_api.c $(SRCDIR)/physics_snapshot.c $(SRCDIR)/physics_broadphase.c $(SRCDIR)/physics_contact_manager.c $(SRCDIR)/physics_ccd.c $(SRCDIR)/physics_raycast.c $(SRCDIR)/physics_step.c $(SRCDIR)/physics_collision_pipeline.c $(SRCDIR)/physics_resolve.c $(SRCDIR)/physics_solver.c $(SRCDIR)/physics_integrate.c
CPP_SOURCES = $(SRCDIR)/physics_memory.cpp $(SRCDIR)/physics_ids.cpp $(SRCDIR)/physics_parallel.cpp $(SRCDIR)/physics_world.cpp
