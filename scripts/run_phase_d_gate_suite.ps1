...
$results += Invoke-Gate -Name "gate_hot_reload_smoke_headless" -FilePath "powershell" -Arguments @("-NoProfile", "-ExecutionPolicy", "Bypass", "-File", "scripts/hot_reload_smoke_headless.ps1", "-SkipBuild")
