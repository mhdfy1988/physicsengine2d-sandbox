...
$exePath = Join-Path $repoRoot "bin\\physics_sandbox.exe"
$distRoot = Join-Path $repoRoot "dist"
$portableRoot = Join-Path $distRoot "PhysicsSandbox"
$zipPath = Join-Path $distRoot "PhysicsSandbox_portable_$Version.zip"
...
Copy-Item -Force $exePath (Join-Path $portableRoot "physics_sandbox.exe")
if (Test-Path "assets") {
