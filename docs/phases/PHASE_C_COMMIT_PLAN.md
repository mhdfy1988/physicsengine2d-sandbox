...
1. `Makefile`
2. `CMakeLists.txt`
3. `scripts/dev/hot_reload_smoke.ps1`
4. `scripts/gate/run_phase_c_gate_suite.ps1`
5. `.gitignore`
...
Scope:
1. `docs/api/SCENE_SCHEMA_V1.md`
2. `docs/api/PREFAB_SCHEMA_V1.md`
3. `docs/api/ASSET_META_V1.md`
4. `docs/api/ASSET_IMPORTER_V1.md`
5. `docs/api/ASSET_PIPELINE_V1.md`
6. `docs/api/ASSET_HOT_RELOAD_V1.md`
7. `docs/phases/PHASE_C_DETAILED_DESIGN.md`
8. `docs/phases/PHASE_C_PROGRESS.md`
9. `docs/phases/PHASE_C_ACCEPTANCE.md`
10. `docs/phases/PHASE_C_EVIDENCE.md`
11. `docs/phases/PHASE_C_GATE_SUITE_20260306_003435.md`
12. `docs/phases/PHASE_C_FINAL_REPORT.md`
