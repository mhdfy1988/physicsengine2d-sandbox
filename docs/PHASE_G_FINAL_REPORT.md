...
8. `powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check_arch_deps.ps1`
9. `powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check_api_surface.ps1`
10. `powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check_cpp_convergence.ps1`
11. `powershell -NoProfile -ExecutionPolicy Bypass -File scripts/run_phase_g_gate_suite.ps1`
