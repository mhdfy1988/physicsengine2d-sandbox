...
3. Boundary freeze for the remaining migration work:
   - `docs/phases/PHASE_E_C_RETENTION_PLAN.md`
   - `scripts/check/check_cpp_convergence.ps1`
4. Directory mapping freeze:
   - `docs/phases/PHASE_E_DIRECTORY_MAPPING.md`
   - `docs/phases/PHASE_E_EVIDENCE.md`
...
9. `scripts/check/check_arch_deps.ps1`
10. `scripts/check/check_api_surface.ps1`
11. `scripts/check/check_cpp_convergence.ps1`
12. `scripts/gate/run_phase_e_gate_suite.ps1`
